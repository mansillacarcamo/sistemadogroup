  ...
  <div class="login-wrapper">
    ...
    <div class="login-panel-right">
      <div class="login-form-container">
        ...
        <div class="mt-4 pt-3 border-top">
          ...
          <div class="d-flex gap-2">
            <a href="despacho_conductor_login.php" class="btn w-100 fw-bold"
              style="background:linear-gradient(135deg,#1b2838,#374151);color:#fff;border:none;padding:.65rem .5rem;border-radius:10px;font-size:.78rem;box-shadow:0 3px 10px rgba(27,40,56,.3);">
            ...
            <a href="despacho_externo_login.php" class="btn w-100 fw-bold"
              style="background:linear-gradient(135deg,#198754,#20c997);color:#fff;border:none;padding:.65rem .5rem;border-radius:10px;font-size:.78rem;box-shadow:0 3px 10px rgba(25,135,84,.3);">
              <i class="bi bi-shield-check d-block mb-1" style="font-size:1.4rem;"></i>
              Carchek
            </a>
            <a href="combustible_responsable_login.php" class="btn w-100 fw-bold"
              style="background:linear-gradient(135deg,#1a1a2e,#d97706);color:#fff;border:none;padding:.65rem .5rem;border-radius:10px;font-size:.78rem;box-shadow:0 3px 10px rgba(217,119,6,.3);">
              <i class="bi bi-fuel-pump-fill d-block mb-1" style="font-size:1.4rem;"></i>
              Combustible
            </a>
          </div>
        </div>
        ...
        <p class="text-center text-muted"><small>Todos los derechos reservados &middot; Desarrollado por <strong>Departamento de Informática DOGroup</strong></small></p>
      </div>
    </div>
  </div>
</body>
