...
if (isset($_GET['csv'])) {
  ...
  fputcsv($out, ['#','Fecha','Hora','Salida','Obra','Conductor','RUT Conductor','PPU','m³','Destino','Material','Cambio','Creado por','Validado por'], ';');
  foreach ($rows as $r) {
    fputcsv($out, [
    ...
    try {
      ...
      foreach ($ticketsDelDia as $t) {
        ...
        $tablaRows .= "<tr>
          ...
          <td style='padding:6px 8px;border:1px solid #ddd;'>" . htmlspecialchars($t['salida_nombre'] ?? '' ?: '—') . "</td>
          ...
          <div style='background:#fff;padding:16px 24px;border:1px solid #dee2e6;'>
            ...
            <table style='width:100%;border-collapse:collapse;font-size:13px;'>
              <thead><tr style='background:#343a40;color:#fff;'>
                ...
                <th style='padding:7px 8px;'>Salida</th>
...
<div class="card border-0 shadow-sm mb-4">
  ...
  <div class="table-responsive">
    <table class="table table-hover align-middle mb-0" style="font-size:.87rem;">
      ...
      <tr><th>#</th><th>Hora</th><th>Conductor</th><th>Salida</th><th>Obra</th><th>PPU</th><th>m³</th><th>Destino</th><th>Material</th><th>Cambio</th><th>Validado por</th></tr>
        </thead>
        <tbody>
...
<div class="d-none d-print-block" style="border-top:1px solid #ccc;padding-top:.5rem;margin-top:1rem;font-size:.7rem;color:#999;display:flex;justify-content:space-between;">
  <span>DOGROUP &copy; <?= date('Y') ?> — Todos los derechos reservados — Desarrollado por Departamento de Informática DOGroup</span>
